...
class ProcessEdge(java.io.Serializable):
    ...
    @typing.overload
    def __init__(self, int: int, processNode: 'ProcessNode', processNode2: 'ProcessNode', energyStream: jneqsim.process.equipment.stream.EnergyStream, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
...
class ProcessGraph(java.io.Serializable):
    ...
    def addEnergyEdge(self, processNode: 'ProcessNode', processNode2: 'ProcessNode', energyStream: jneqsim.process.equipment.stream.EnergyStream) -> ProcessEdge: ...
