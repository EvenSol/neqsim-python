...
class SoftSensor(jneqsim.process.measurementdevice.StreamMeasurementDeviceBaseClass, jneqsim.process.dynamics.TransientStateParticipant['SoftSensor.SoftSensorState']):
    ...
    def captureTransientState(self) -> 'SoftSensor.SoftSensorState': ...
    @typing.overload
    ...
    def restoreTransientState(self, softSensorState: 'SoftSensor.SoftSensorState') -> None: ...
    ...
    class SoftSensorState(java.io.Serializable): ...
