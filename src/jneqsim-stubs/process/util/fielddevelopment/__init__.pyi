...
class BioprocessConceptEvaluator(java.io.Serializable):
    def __init__(self): ...
    def addConcept(self, conceptCase: 'BioprocessConceptEvaluator.ConceptCase') -> None: ...
    def evaluate(self) -> None: ...
    def getRankedResults(self, rankingMetric: 'BioprocessConceptEvaluator.RankingMetric') -> java.util.List['BioprocessConceptEvaluator.ConceptResult']: ...
    def setClosureTolerance(self, double: float) -> None: ...
    def setEconomicBasis(self, double: float, int: int) -> None: ...
    class ConceptCase(java.io.Serializable):
        def __init__(self, string: typing.Union[java.lang.String, str]): ...
        def setAnnualEmissionsTCO2Equivalent(self, double: float) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setAnnualProduct(self, double: float, string: typing.Union[java.lang.String, str]) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setClosure(self, double: float, double2: float) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setCosts(self, double: float, double2: float) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setEnergyMWhPerUnit(self, double: float) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setProductPricePerUnit(self, double: float) -> 'BioprocessConceptEvaluator.ConceptCase': ...
        def setQualification(self, modelFidelity: jneqsim.process.equipment.reactor.digestion.ModelFidelity, string: typing.Union[java.lang.String, str]) -> 'BioprocessConceptEvaluator.ConceptCase': ...
    class ConceptResult(java.io.Serializable):
        def getCarbonIntensityKgCO2EquivalentPerMWh(self) -> float: ...
        def getLevelizedProductCost(self) -> float: ...
        def getName(self) -> java.lang.String: ...
        def getNetPresentValue(self) -> float: ...
        def getWarnings(self) -> java.util.List[java.lang.String]: ...
        def isClosureQualified(self) -> bool: ...
        def toMap(self) -> java.util.Map[java.lang.String, typing.Any]: ...
    class RankingMetric(java.lang.Enum['BioprocessConceptEvaluator.RankingMetric']):
        NET_PRESENT_VALUE: typing.ClassVar['BioprocessConceptEvaluator.RankingMetric'] = ...
        LEVELIZED_PRODUCT_COST: typing.ClassVar['BioprocessConceptEvaluator.RankingMetric'] = ...
        CARBON_INTENSITY: typing.ClassVar['BioprocessConceptEvaluator.RankingMetric'] = ...
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'BioprocessConceptEvaluator.RankingMetric': ...
        @staticmethod
        def values() -> typing.MutableSequence['BioprocessConceptEvaluator.RankingMetric']: ...
...
class __module_protocol__(Protocol):
    ...
    BioprocessConceptEvaluator: typing.Type[BioprocessConceptEvaluator]
