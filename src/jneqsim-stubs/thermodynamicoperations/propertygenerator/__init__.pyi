...
class OLGAhydrateCurveGenerator(jneqsim.thermodynamicoperations.BaseOperation):
    def __init__(self, systemInterface: jneqsim.thermo.system.SystemInterface): ...
    def displayResult(self) -> None: ...
    def getCurveLabel(self) -> java.lang.String: ...
    def getCurvePressures(self) -> typing.MutableSequence[float]: ...
    def getCurveTemperatures(self) -> typing.MutableSequence[float]: ...
    def getHydrateCheckKeyword(self) -> java.lang.String: ...
    def run(self) -> None: ...
    def setCurveLabel(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setPressureRange(self, double: float, double2: float, int: int) -> None: ...
    def toKeywordBlock(self) -> java.lang.String: ...
...
class OLGApropertyTableGeneratorKeywordFormat(jneqsim.thermodynamicoperations.BaseOperation):
    ...
    def calcPhaseEnvelope(self) -> None: ...
    def displayResult(self) -> None: ...
    def getFluidLabel(self) -> java.lang.String: ...
    def initCalc(self) -> None: ...
    def run(self) -> None: ...
    def setFluidLabel(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setPressureRange(self, double: float, double2: float, int: int) -> None: ...
    def setTemperatureRange(self, double: float, double2: float, int: int) -> None: ...
    def writeOLGAinpFile(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    OLGAhydrateCurveGenerator: typing.Type[OLGAhydrateCurveGenerator]
